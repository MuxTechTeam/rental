            ...
            <div class="modal-body">
                ...
                <div class="col-md-12"> 
                        <ul class="nav nav-tabs">
                            <li class="active" id="CustomPricetab"><a data-toggle="tab" href="#CustomPrice">Custom Price</a></li>
                            <li id="PainReservationtab"><a data-toggle="tab" href="#PainReservation">Period reservation</a></li>
                        </ul>
                        <br>              
                        <div class="tab-content">
                            <div id="CustomPrice" class="tab-pane fade in active"> 
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-12 clean_reservation">
                                    ...
                                    <label for="book_notes"><?php echo esc_html__( 'Detail','wprentals');?></label>
                            ...
                            <div id="PainReservation" class="tab-pane fade">
                                <div class="col-md-9">
                                    <label for="email_address"><?php echo esc_html__( 'Email','wprentals') ;?></label>
                                    <input type="text" id="email_address" size="40" name="email_address" class="form-control" value="">
                                </div>
                                <input type="hidden" name="existingGuestID" id="existingGuestID">
                                <div class="col-md-3">
                                    <label for="checkEmailExist"><?php echo esc_html__( 'check','wprentals') ;?></label>
                                    <button type="button" class="form-control" id="checkEmailExist"><i class="fa fa-envelope" aria-hidden="true"></i></button>
                                </div>
                                <div class="col-md-6">
                                    <label for="firstName"><?php echo esc_html__( 'First Name','wprentals') ;?></label>
                                    <input type="text" id="firstName" size="40" name="firstName" class="form-control" value="">
                                </div>
                                <div class="col-md-6">
                                    <label for="lastName"><?php echo esc_html__( 'Last Name','wprentals') ;?></label>
                                    <input type="text" id="lastName" size="40" name="lastName" class="form-control" value="">
                                </div>
                                <div class="col-md-6">
                                    <label for="start_date_owner_book"><?php esc_html_e('Start Date','wprentals');?></label>
                                    <input type="text" id="start_date_gust" size="40" name="start_date_gust" class="form-control" value="">
                                </div>
                                <div class="col-md-6">
                                    <label for="end_date_owner_book"><?php  esc_html_e('End Date','wprentals');?></label>
                                    <input type="text" id="end_date_gust" size="40" name="end_date_gust" class="form-control" value="">
                                </div>
                                <div class="col-md-6">
                                    <label for="coment"><?php echo esc_html__( 'Price','wprentals').' '.$wp_estate_currency_symbol;?></label>
                                    <input type="text" id="bookingPrice" size="40" name="bookingPrice" class="form-control" value="">
                                </div>
                            </div>  
                        </div>  
                </div> 
                ...
                <button type="submit" style="display: none;
                    ...
                    margin-left: 15px;
                    margin-top: 10px;
                " id="allinone_book_for_gust" class="wpb_button  wpb_btn-info  wpb_regularsize   wpestate_vc_button  vc_button"><?php esc_html_e('Book','wprentals');?></button>
            </div><!-- /.modal-body -->
        ...
        if( !$prop_selection->have_posts() ){
           ...
           if(!empty($properties))
            foreach($properties as $key => $value){
                if($key==0){
                    $calendar_output.='<div class="prop_categ">Bed: '.$value['bed'].'</div>';
                }
